...
// LLAMA_EXPORT char* global_experts_path;
// LLAMA_EXPORT int32_t global_load_experts_number = 128;
...
static int llama_model_load(const std::string & fname, std::vector<std::string> & splits, llama_model & model, llama_model_params & params) {
    ...
    model.experts_path = params.experts_path;
    model.load_experts_number = params.load_experts_number;
