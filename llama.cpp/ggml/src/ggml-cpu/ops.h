...
void ggml_compute_forward_argsort_load_first(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_argsort_load_first_2(const struct ggml_compute_params * params, struct ggml_tensor * dst);
